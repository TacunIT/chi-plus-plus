...
permalink:  /man/en/struttura-dei-programmi
...
<a href="/man/en/preprocessore" class="xref">in seguito</a>.
...
Riducendo la complessità della funzione, inoltre, abbiamo la possibilità di dichiararla come <a href="/man/en/funzioni#inline" class="xref">inline</a>, aumentando la velocità di esecuzione del programma.
...
<a href="/man/en/mitopoietica#annosa-dicotomia" class="xref">*l'annosa dicotomia fra ciò che desideriamo è ciò di cui abbiamo bisogno*</a>.   
...
La Gravità è al suo punto estremo e una non-esistenza scorre in un non-tempo, che non può essere misurato perché non esistono eventi in base a cui farlo.<a id="non-tempo" class="nota" href="/man/en/note#fn-fn-non-tempo">1</a>
...
> {{ site.data.citazioni.gita.cicli }}<a class="nota" href="/man/en/note#fn-cicli" id="cicli">2</a>
...
> {{ site.data.citazioni.dawkins.tempo }} <a class="nota" href="/man/en/note#fn-dawkins-tempo" id="dawkins-tempo">3</a>
