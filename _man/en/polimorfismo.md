...
Avevamo iniziato a parlarne durante la <a href="/man/en/c-plus-plus#polimorfismo" class="xref">lezione introduttiva sul C++</a> e l'avevamo illustrato con un esempio che, a questo punto, non dovrebbe più avere segreti, per te:
...
Quando il compilatore trova nel codice un template, sia esso la dichiarazione di una classe o una chiamata a funzione, la sostituisce con il codice corrispondente, così come avviene per le <a href="/man/en/preprocessore#macro" class="xref">macro-istruzioni del precompilatore</a>, ma, a differenza di quello che avviene per le macro, il tipo dei parametri del template è sottoposto a uno stretto controllo, così come il resto del codice.  
...
Essendo un sostenitore del secondo metodo, il Maestro Canaro lo applicò anche al C'hi++ e, dopo alcuni di anni di studio, arrivò alla conclusione che non solo è possibile ipotizzare una cosmogonia quasi del tutto priva di elementi metafisici (non del tutto priva, perché, come vedremo <a href="/man/en/stream#dottrina" class="xref">in seguito</a>, una dose minima di trascendenza è necessaria per garantire la buona funzionalità della dottrina), ma che i precetti di questa dottrina erano compatibili con molti  principii delle religioni canoniche.  
...
Come abbiamo detto <a href="/man/en/istruzioni-condizionali#pentimento" class="xref">in precedenza</a> e come vedremo durante la lezione sul <a href="/man/en/debug#pentimento" class="xref">debug</a>, il C'hi++ concorda con questa idea.  
Similmente, ci
-->
...
Oltre alla citazione che ti ho fatto parlando del <a href="/man/en/programmatore#azione" class="xref">programmatore</a>, nella *Gita* è possibie trovare alcuni brani che ricordano molto le affermazioni contenute in *Sostiene Aristotele*; per esempio, quelle sulla natura dell'Universo:
...
> {{ site.data.citazioni.guenon.spirito }}<a class="nota" href="/man/en/note#fn-guenon-spirito" id="guenon-spirito">1</a>
...
> {{ site.data.citazioni.dawkins.analogia }}<a class="nota" href="/man/en/note#fn-dawkins-analogia" id="dawkins-analogia">2</a>
...
Il C'hi++, però, può dare forza a quelle (tante) persone che *ancora credono in tutto ciò in cui più nessuno crede*, come li descrisse Longanesi; quella *Banda degli Onesti*<a class="nota" href="/man/en/note#fn-banda-onesti" id="banda-onesti">3</a> che tutti i giorni fa il proprio dovere al meglio possibile anche se non gli conviene, anche tutto e tutti intorno a loro sembrano spingerli all'egoismo e all'indifferenza.
