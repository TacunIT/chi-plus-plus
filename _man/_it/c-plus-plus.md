...
Oltre alle classi template predefinite della *Standard Template Library*, il C++ permette di definire le proprie classi template, ma di questo parleremo <a href="/it/polimorfismo#template" class="xref">a tempo debito</a>.  
...
> {{ site.data.citazioni.stroustrup.java }} <a id="stroustrup" href="/it/note#fn-cpp" class="nota">1</a>
