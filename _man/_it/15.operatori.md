...
Prendi per esempio i programmi che gestiscono le basi di dati: per *Access*, il valore booleano *false* è `-1`; per le prime versioni di *Postgres* è `f`; per MySQL o Oracle, è `0`.  
