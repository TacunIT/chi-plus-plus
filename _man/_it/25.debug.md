...
Un puntatore utilizzato impropriamente, un ciclo in più o in meno in un'istruzione `for` o una virgola dimenticata fra i parametri di una `printf`: qualunque cosa sia, se il compilatore non sarà in grado di riconoscerla, finirà nel programma e resterà lì in attesa di produrre i suoi effetti dannosi.
...
Le persone a cui facciamo del male sono spesso quelle a cui siamo più legati; far sapere loro che non li abbiamo dimenticati e che ciò che è successo ci addolora, può servire a ricucire delle ferite; dall'una e dall'altra parte.
