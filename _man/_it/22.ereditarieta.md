...
quote:      "Una classe padre può ripudiare una classe figlia, se è cattiva, ma una classe figlia non può ripudiare la sua classe padre perché gli deve più di quanto non sia in grado di pagargli e in particolare gli deve l'esistenza."
status:     pubblicato
...
In un linguaggio come il *C*, che non permette l'ereditarietà, quindi, si dovranno prevedere due strutture di dati differenti per ciascun caso:
