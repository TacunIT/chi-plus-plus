...
og_desc:    "Il problema dei romanzi - Le regole di vita di Miyamoto Musashi - La Verità è una modella - La Via del carpentiere."
---
...
Il flusso di un programma *non banale*, come direbbe Stroustrup, sarà sempre suddiviso in più funzioni perché in questo modo il codice sarà più facile da leggere, da correggere e da modificare.  
...
In un romanzo sulla vita dello spadaccino giapponese Miyamoto Musashi c'è una frase che è la logica conseguenza del suggerimento romanesco di cui ti ho parlato ieri:

> {{ site.data.citazioni.musashi.romanzo }}<a href="/it/note#fn-musashi" class="nota" id="musashi">4</a>
