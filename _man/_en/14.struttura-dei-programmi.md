...
permalink:  /en/struttura-dei-programmi
...
<a href="/en/preprocessore" class="xref">in seguito</a>.
...
Il *coupling* <!-- uso il termine inglese per evitare anfibologie con l'attività sessuale.. --> è come il colesterolo: più è basso, meglio è; quindi, per evitare errori, dobbiamo ridurlo, creando un `enum` a cui assegnare i possibili valori del parametro `azione`:
...
Riducendo la complessità della funzione, inoltre, abbiamo la possibilità di dichiararla come <a href="/en/funzioni#inline" class="xref">inline</a>, aumentando la velocità di esecuzione del programma.
...
<a href="/en/mitopoietica#annosa-dicotomia" class="xref">*l'annosa dicotomia fra ciò che desideriamo è ciò di cui abbiamo bisogno*</a>.   
...
La Gravità è al suo punto estremo e una non-esistenza scorre in un non-tempo, che non può essere misurato perché non esistono eventi in base a cui farlo.<a id="non-tempo" class="nota" href="/en/note#fn-fn-non-tempo">1</a>
...
> {{ site.data.citazioni.gita.cicli }}<a class="nota" href="/en/note#fn-cicli" id="cicli">2</a>
...
> {{ site.data.citazioni.dawkins.tempo }} <a class="nota" href="/en/note#fn-dawkins-tempo" id="dawkins-tempo">3</a>
