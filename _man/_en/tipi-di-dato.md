...
<a href="/en/funzioni" class="xref">in seguito</a>.
...
<a href="/en/funzioni" class="xref">funzioni</a>.
...
> {{ site.data.citazioni.agostino }} <a id="agostino" href="/en/note#fn-agostino" class="nota">1</a>
...
Come scrisse Ezra Pound<a id="pound" href="/en/note#fn-pound" class="nota">2</a>, solo i sogni esistono realmente, perché la loro natura irreale rimane tale anche in una realtà illusoria.
