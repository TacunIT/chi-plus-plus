...
Abbiamo visto degli esempii di questa caratteristica quando abbiamo parlato di <a href="/en/c-plus-plus#polimorfismo" class="xref">polimorfismo</a> e di <a href="/en/polimorfismo#overload-operatori" class="xref">overload degli operatori</a>:
...
Entrambi questi dati membro sono delle bitmask<a class="nota" href="/en/note#fn-bitmask" id="bitmask">1</a>, quindi possono contenere più di un valore.
...
Le torri si muovono in orizzontale, gli alfieri in diagonale e il cavallo salta con una traiettoria a “L” in ossequio a delle regole definite al di fuori della scacchiera<a class="nota" href="/en/note#fn-scacchi" id="scacchi">2</a>, ma è proprio da queste limitazioni che deriva il fascino del gioco.
