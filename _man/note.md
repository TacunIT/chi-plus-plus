...
<section class="note">
    ...
    <ol>
        <li id="azione">
            <span class="autore">P. Scarabelli, M. Vinti</span>,
    ...
    <ol>
        <li id="cpp">
            <span class="autore">B. Stroustrup</span>, 
    ...
    <ol>
        ...
        <li id="pound">
            ...
            <span class="autore">E. Pound</span>, <i>Song</i> 
    ...
    <ol>
        ...
        <li id="dawkins-tempo">
            <span class="autore">R. Dawkins</span>, 
    ...
    <ol>
        ...
        <li id="russell">
            ...
            <span class="autore">B. Russell</span>
        ...
        <li id="freemen">
            <span class="autore">H. Wiencek</span>,
        ...
        <li id="black">
            <span class="autore">E. Black</span>, 
    ...
    <ol>
        <li id="steward">
            ...
            Citato da <span class="autore">P. Gewirtz</span>, 
    ...
    <ol>
        <li id="zen">
            <span class="autore">N. Senzaki, P. Reps</span>, 
            <i>101 Storie Zen</i>, 
            Adelphi, Milano, 1973
        ...
        <li id="isolamento">
            ...
            Citato da <span class="autore">M. Deen</span>,
        ...
        <li id="yoga">
            Citato da <span class="autore">A. K. Coomaraswami</span>, 
    ...
    <ol>
        ...
        <li id="stack">
            ...
            <span class="autore">C. Munisso, C. Simonelli</span>, 
            <i>Dal C a Windows</i>,
            Logica, Roma, 1995
            <a href="/man/funzioni#stack"><i class="fas fa-reply"></i></a>
        </li>
        <li id="musashi">
            <span class="autore">E. Yoshikawa</span>,
            <i>Musashi</i>,
            Rizzoli, Milano, 1994
