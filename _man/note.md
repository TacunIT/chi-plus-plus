...
<section class="note">
    ...
    <ol>
        <li>
            ...
            <a href="Javascript:history.back()" name="jefferson"><i class="fas fa-reply"></i></a>
        </li>
        <li id="self-evident">
    ...
    <ol>
        ...
        <li>
            ...
            <a href="Javascript:history.back()" name="samyutta"><i class="fas fa-reply"></i></a>
        </li>
        <li>
        ...
        <li>
            ...
            <i>Dal C a Windows</i>,
            Logica, Roma, 1995
            <a href="Javascript:history.back()" name="stack"><i class="fas fa-reply"></i></a>
        </li>
        <li>
            <i>Es. 32.27</i>,
            <a href="Javascript:history.back()" name="levi"><i class="fas fa-reply"></i></a>
        </li>
        <li>
            Dati SIPRI <a href="https://www.sipri.org"
                target="note">www.sipri.org</a>.
            <a href="Javascript:history.back()" name="armi"><i class="fas fa-reply"></i></a>
        </li>
    </ol>
