...
<section class="note">
    ...
    <ol>
        <li id="saadi">
            ...
            <a href="/man/istruzioni-condizionali#"><i class="fas fa-reply"></i></a>
        </li>
        <li id="mantiq">
            F. <span>Attar</span>, 
            <i>Il verbo degli uccelli (Mantiq al-Tayr)</i>, 
    ...
    <ol>
        <li id="aristotele">
            ...
            <a href="/man/istruzioni-iterative#"><i class="fas fa-reply"></i></a>
        </li>
        <li id="blackfriday">
    ...
    <ol>
        <li id="selvaggio">
            ...
            <a href="/man/classi#"><i class="fas fa-reply"></i></a>
        </li>
        <li id="inline">
    ...
    <ol>
        <li id="miti">
            ...
            <a href="/man/ereditarieta#"><i class="fas fa-reply"></i></a>
        </li>
        <li id="fusto">
    ...
    <ol>
        <li id="dawkins-analogia">
            ...
            <i>L'Orologiaio Cieco</i>, 
            Mondadori, Milano, 2016 
            <a href="/man/polimorfismo#"><i class="fas fa-reply"></i></a>
        </li>
        <li id="banda-onesti">
    ...
    <ol>
        <li id="bitmask">
            ...
            <a href="/man/stream#"><i class="fas fa-reply"></i></a>
        </li>    
        <li id="scacchi">
    ...
    <ol>
        <li id="bottom-down">
            ...
            <a href="/man/debug#"><i class="fas fa-reply"></i></a>
        </li>    
        <li id="croce">
