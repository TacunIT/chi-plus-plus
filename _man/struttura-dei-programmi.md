...
<a href="/man/preprocessore" class="xref">in seguito</a>.
...
Riducendo la complessità della funzione, inoltre, abbiamo la possibilità di dichiararla come <a href="/man/funzioni#inline" class="xref">inline</a>, aumentando la velocità di esecuzione del programma.
...
La Gravità è al suo punto estremo e una non-esistenza scorre in un non-tempo, che non può essere misurato perché non esistono eventi in base a cui farlo.<a id="non-tempo" class="nota" href="/man/note#fn-fn-non-tempo">1</a>
...
> {{ site.data.citazioni.gita.cicli }}<a class="nota" href="/man/note#fn-cicli" id="cicli">2</a>
...
> {{ site.data.citazioni.dawkins.tempo }} <a class="nota" href="/man/note#fn-dawkins-tempo" id="dawkins-tempo">3</a>
