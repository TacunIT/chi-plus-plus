...
> {{ site.data.citazioni.guenon.spirito }}<a class="nota" href="/man/note#fn-guenon-spirito" id="guenon-spirito">1</a>
...
> {{ site.data.citazioni.dawkins.analogia }}<a class="nota" href="/man/note#fn-dawkins-analogia" id="dawkins-analogia">2</a>
...
Il C'hi++, però, può dare forza a quelle (tante) persone che *ancora credono in tutto ciò in cui più nessuno crede*, come li descrisse Longanesi; quella *Banda degli Onesti*<a class="nota" href="/man/note#fn-banda-onesti" id="banda-onesti">3</a> che tutti i giorni fa il proprio dovere al meglio possibile anche se non gli conviene, anche tutto e tutti intorno a loro sembrano spingerli all'egoismo e all'indifferenza.
